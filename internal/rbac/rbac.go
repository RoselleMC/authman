...
var Catalog = []Permission{
	...
	{Key: "nodes.read", Group: "velocity", Label: "View Velocity nodes", Description: "Read registered Velocity plugin instances and heartbeats."},
	{Key: "nodes.write", Group: "velocity", Label: "Manage Velocity nodes", Description: "Create, disable, rotate, and remove Velocity node credentials."},
