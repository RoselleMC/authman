...
func (s *Server) routes() {
	...
	s.coreMux.HandleFunc("POST /api/admin/session/password-reset/request", s.handleAdminPasswordResetRequest)
	s.coreMux.HandleFunc("POST /api/admin/session/password-reset/confirm", s.handleAdminPasswordResetConfirm)
	...
	s.coreMux.HandleFunc("DELETE /api/admin/passports/{id}", s.handleAdminDeletePassport)
	s.coreMux.HandleFunc("POST /api/admin/passports/{id}/portal-link", s.handleAdminCreatePortalLink)
	s.coreMux.HandleFunc("POST /api/admin/passports/{id}/reset-password", s.handleAdminResetOfflinePassword)
	...
	s.coreMux.HandleFunc("DELETE /api/admin/profiles/{id}", s.handleAdminDeleteProfile)
	...
	s.coreMux.HandleFunc("DELETE /api/admin/portal-links/{id}", s.handleAdminRevokePortalLink)
	...
	s.coreMux.HandleFunc("GET /api/admin/login-portals/{id}/protocol-pack", s.handleAdminGetLimboProtocolPack)
	s.coreMux.HandleFunc("PUT /api/admin/login-portals/{id}/protocol-pack", s.handleAdminUploadLimboProtocolPack)
	s.coreMux.HandleFunc("DELETE /api/admin/login-portals/{id}/protocol-pack", s.handleAdminDeleteLimboProtocolPack)
	s.coreMux.HandleFunc("GET /api/admin/login-portals/{id}/protocol-pack/download", s.handleAdminDownloadLimboProtocolPack)
	...
	s.coreMux.HandleFunc("GET /api/admin/downstream-servers/{id}/player-messages", s.handleAdminDownstreamServerPlayerMessages)
	s.coreMux.HandleFunc("PUT /api/admin/downstream-servers/{id}/player-messages", s.handleAdminUpdateDownstreamServerPlayerMessages)
	...
	s.coreMux.HandleFunc("POST /api/admin/account/password", s.handleAdminAccountPassword)
	...
	s.coreMux.HandleFunc("POST /api/node/profiles/rename", s.handleNodeRenameProfile)
	s.coreMux.HandleFunc("POST /api/node/players/authenticate", s.handleNodeAuthenticatePlayer)
	s.coreMux.HandleFunc("POST /api/node/players/remember-auth", s.handleNodeRememberPortalAuth)
