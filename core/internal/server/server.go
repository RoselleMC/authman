...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("GET /api/assets/passports/{id}/{asset}", s.handlePassportSkinAsset)
	...
	s.mux.HandleFunc("POST /api/portal/profiles", s.handlePortalCreateProfile)
	s.mux.HandleFunc("POST /api/portal/profiles/{id}/archive", s.handlePortalArchiveProfile)
	s.mux.HandleFunc("POST /api/portal/profiles/{id}/restore", s.handlePortalRestoreProfile)
	...
	s.mux.HandleFunc("GET /api/portal/profile/skin", s.handlePortalProfileSkin)
	s.mux.HandleFunc("POST /api/portal/profile/skin", s.handlePortalUploadProfileSkin)
	s.mux.HandleFunc("DELETE /api/portal/profile/skin", s.handlePortalDeleteProfileSkin)
	...
	s.mux.HandleFunc("POST /api/admin/passports/{id}/skin", s.handleAdminUploadPassportSkin)
	s.mux.HandleFunc("DELETE /api/admin/passports/{id}/skin", s.handleAdminDeletePassportSkin)
	...
	s.mux.HandleFunc("POST /api/admin/profiles/{id}/skin/source", s.handleAdminSetProfileSkinSource)
