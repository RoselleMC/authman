...
const PATHS: Record<string, string> = {
  ...
  settings:
    "M10 12.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5ZM10 2.5v2 M10 15.5v2 M17.5 10h-2 M4.5 10h-2 M15.3 4.7l-1.4 1.4 M6.1 13.9l-1.4 1.4 M15.3 15.3l-1.4-1.4 M6.1 6.1L4.7 4.7",
